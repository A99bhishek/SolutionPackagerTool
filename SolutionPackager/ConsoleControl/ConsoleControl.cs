...
namespace ConsoleControl
{
    ...
    public partial class ConsoleControl : UserControl
    {
        ...
        public event EventHandler ProcessExist;
        /// <summary>
        ...
        void processInterace_OnProcessExit(object sender, ProcessInterface.ProcessEventArgs args)
        {
            ...
            EventHandler handler = ProcessExist;
            if (handler != null)
            {
                handler(this, args);
            }
...
//WriteInput("\x3", Color.White, false);
            ...
            if (e.KeyCode == Keys.Return)
            {
                ...
                WriteInput(input, Color.Red, false);
            }
        }
        ...
        {           
            ...
            //  Start the process.
         bool pcstatus=   processInterace.StartProcess(fileName, arguments);
